...
public class Monedas extends Conversor{
	...
	private static double dolar = 200.10;
	private static double euro = 215.62;
	private static double libra = 243.67;
	private static double yen = 1.52;
	private static double won = 0.15;
	...
	public double operarDeExtranjeraAPesos(String monedaElegida, double pesos) {
		switch (monedaElegida) {
			...
			case "Libras Esterlinas a pesos":
				this.tasaDivisa = pesos * this.libra;
				JOptionPane.showMessageDialog(null, (pesos + " libras esterlinas son: " + Math.floor(this.tasaDivisa) + " ARS."));
				break;
			case "Yen Japonés a pesos":
				this.tasaDivisa = pesos * this.yen;
				JOptionPane.showMessageDialog(null, (pesos + " yenes son: " + Math.floor(this.tasaDivisa) + " ARS."));
				break;
			case "Won sul-coreano a pesos":
				this.tasaDivisa = pesos * this.won;
		        JOptionPane.showMessageDialog(null, (pesos + " wones son: " + Math.floor(this.tasaDivisa) + " ARS."));
				break;
			default:
				break;
			}
